...
const pdfData = {
    ...
    quiz: [
        {
            question: "When was Policybazaar launched?",
            options: ["2006", "2008", "2010", "2012"],
            correct: 1,
            explanation: "Policybazaar was launched in 2008, marking the beginning of India's digital insurance revolution."
        },
        {
            question: "What is Policybazaar's online market share in FY25?",
            options: ["85.4%", "90.2%", "93.4%", "96.8%"],
            correct: 2,
            explanation: "Policybazaar commands an impressive 93.4% online market share, making it India's undisputed leader."
        },
        {
            question: "When did Policybazaar become a unicorn?",
            options: ["2016", "2017", "2018", "2019"],
            correct: 2,
            explanation: "Policybazaar achieved unicorn status in 2018, crossing the $1 billion valuation milestone."
        },
        {
            question: "How many crore policies did Policybazaar sell in FY25?",
            options: ["3.52 Crores", "4.18 Crores", "5.26 Crores", "6.45 Crores"],
            correct: 2,
            explanation: "Policybazaar sold 5.26 crore policies in FY25, helping millions of Indians secure their future."
        },
        {
            question: "What is NOT a core value of Policybazaar?",
            options: ["Transparency", "Simplification", "Protection", "Maximization"],
            correct: 3,
            explanation: "Policybazaar's core values are Transparency, Simplification, and Protection - not maximization."
        },
        {
            question: "When was Paisabazaar launched?",
            options: ["2012", "2013", "2014", "2015"],
            correct: 2,
            explanation: "Paisabazaar was launched in 2014, expanding the PB Fintech ecosystem to loans and credit services."
        },
        {
            question: "How many pin codes does PB Partners cover?",
            options: ["12,000+", "15,000+", "18,000+", "20,000+"],
            correct: 2,
            explanation: "PB Partners has an extensive reach covering 18,000+ pin codes across India."
        },
        {
            question: "What was the insurance premium handled by Policybazaar in FY25?",
            options: ["₹22,500 Cr", "₹25,800 Cr", "₹28,100 Cr", "₹31,400 Cr"],
            correct: 2,
            explanation: "Policybazaar handled ₹28,100 crores in insurance premium during FY25."
        },
        {
            question: "Which technology is NOT mentioned in the Future of InsurTech?",
            options: ["AI & ML", "Blockchain", "Quantum Computing", "Smart Contracts"],
            correct: 2,
            explanation: "While AI, Blockchain, and Smart Contracts are key technologies, Quantum Computing wasn't mentioned in the presentation."
        },
        {
            question: "When did Policybazaar launch its IPO?",
            options: ["2019", "2020", "2021", "2022"],
            correct: 2,
            explanation: "Policybazaar went public with its IPO in 2021, marking another major milestone."
        }
    ],
